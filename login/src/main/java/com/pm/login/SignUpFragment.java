...
import com.pm.login.diglog.BottomSelectDialog;
import com.pm.login.utils.LoginUtil;
...
public class SignUpFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.login_sign_up_fragment, container, false);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.btn_start_sign_up) {
            attemptSignUp();
        }
    }
