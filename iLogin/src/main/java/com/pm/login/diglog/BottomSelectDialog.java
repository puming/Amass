...
public class BottomSelectDialog extends BaseDialogFragment {
    ...
    public int getResLayoutId() {
        return R.layout.login_dialog_fragment_bottom_select;
    }

    @Override
    public void initStyle() {
        setStyle(DialogFragment.STYLE_NORMAL, R.style.login_BottomFragmentDialogWithAnim);
    }
    ...
    public void initViews(View view) {
        ...
        RecyclerView.Adapter<BaseViewHolder> adapter = new RecyclerView.Adapter<BaseViewHolder>() {
            ...
            public BaseViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View item = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.login_item_select_list, viewGroup, false);
